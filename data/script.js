...
function botellas(a,b){
  ...
  <style> main{grid-template-columns: repeat(`+(a==0 ? botella[a][b].length : botella[a].length)+`,`+(botella[a].length > 3 ? "35" : 100/botella[a].length)+`%)}</style>
  <header><p><img src="./img/logoGarufa.png"><stronge><img src="./img/flags/0`+( a > 7 ? 7 : a )+`.png"><br>`+(a==0 ? zac[b].name : menuC[a].name )+`</stronge></p></header>
  <main id ="main">`; 
  ...
  [//Zacatecanos
    ...
    [//Tierra Adentro
      ...
      },
      {
        ...
        maridaje:"Risotto de hongos, cortes añejados, lomo de cerdo y pork belly.",
      ...
      },
      {
        ...
        flag: true,
        uva:"Malbec.",
        aroma:"Con aromas a frutos negros,  flores como violetas, de gran intensidad, se perciben la ciruela y la cereza con notas de madera.",
